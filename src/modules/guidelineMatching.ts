import type { ModuleRegistration, ModuleRunContext } from "../types.js";
    ...
    import type { ContentHash, GuidelineDecisionPointClaim } from "@risx/common";
     ...
     *
     * AR1 Stage 2: `GuidelineDecisionPointClaim` migrated from module-local to
     * the shared @risx/common contract (ADR-0006). This module imports the type
     * from `@risx/common` — the single source of truth for what the Knowledge
     * Compiler produces and what this module reads.
     */
